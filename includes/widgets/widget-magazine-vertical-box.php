...
class Treville_Pro_Magazine_Vertical_Box_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => esc_html__( 'Displays your posts from a selected category in a vertical box.', 'treville-pro' ),
	...
	private function default_settings() {
		...
		$defaults = array(
			'title'    => esc_html__( 'Magazine (Vertical Box)', 'treville-pro' ),
			'category' => 0,
		);
	...
	function widget( $args, $instance ) {
		...
		?>
		<div class="widget-magazine-vertical-box widget-magazine-posts clearfix">

			<?php // Display Title.
			$this->widget_title( $args, $settings ); ?>

			<div class="widget-magazine-content magazine-vertical-box clearfix">
	...
	function render( $settings ) {
		...
		// Get cached post ids.
		$post_ids = treville_get_magazine_post_ids( $this->id, $settings['category'], 4 );
