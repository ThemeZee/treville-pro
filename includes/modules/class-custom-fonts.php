...
class Treville_Pro_Custom_Fonts {
	...
	static function setup() {
		...
		require_once TREVILLE_PRO_PLUGIN_DIR . 'includes/customizer/class-font-list.php';
		require_once TREVILLE_PRO_PLUGIN_DIR . 'includes/customizer/class-customize-font-control.php';
		require_once TREVILLE_PRO_PLUGIN_DIR . 'includes/customizer/class-customize-font-list-control.php';

		// Add Custom Color CSS code to custom stylesheet output.
		add_filter( 'treville_pro_custom_css_stylesheet', array( __CLASS__, 'custom_fonts_css' ) );

		// Load custom fonts from Google web font API.
		add_filter( 'treville_google_fonts_url', array( __CLASS__, 'google_fonts_url' ) );
	 ...
	 *
	 * @uses treville_google_fonts_url filter hook
	...
	static function google_fonts_url( $google_fonts_url ) {
		...
		$default_fonts = Treville_Pro_Custom_Font_Lists::default_browser_fonts();
	...
	static function font_settings( $wp_customize ) {
		...
		$wp_customize->add_section( 'treville_pro_section_fonts', array(
			'title'    => __( 'Theme Fonts', 'treville-pro' ),
			'priority' => 70,
		...
		$wp_customize->add_control( new Treville_Pro_Customize_Font_Control(
			$wp_customize, 'text_font', array(
				'label'      => __( 'Base Font', 'treville-pro' ),
				'section'    => 'treville_pro_section_fonts',
		...
		$wp_customize->add_control( new Treville_Pro_Customize_Font_Control(
			$wp_customize, 'title_font', array(
				'label'      => _x( 'Headings', 'font setting', 'treville-pro' ),
				'section'    => 'treville_pro_section_fonts',
		...
		$wp_customize->add_control( new Treville_Pro_Customize_Font_Control(
			$wp_customize, 'navi_font', array(
				'label'      => _x( 'Navigation', 'font setting', 'treville-pro' ),
				'section'    => 'treville_pro_section_fonts',
		...
		$wp_customize->add_control( new Treville_Pro_Customize_Font_Control(
			$wp_customize, 'widget_title_font', array(
				'label'      => _x( 'Widget Titles', 'font setting', 'treville-pro' ),
				'section'    => 'treville_pro_section_fonts',
		...
		$wp_customize->add_setting( 'treville_theme_options[available_fonts]', array(
			'default'           => 'favorites',
			'type'           	=> 'option',
			'transport'         => 'postMessage',
			'sanitize_callback' => array( 'Treville_Pro_Custom_Fonts', 'sanitize_available_fonts' ),
			)
		);
		$wp_customize->add_control( new Treville_Pro_Customize_Font_List_Control(
			$wp_customize, 'treville_control_available_fonts', array(
				'label'      => __( 'Choose available Fonts', 'treville-pro' ),
				'section'    => 'treville_pro_section_fonts',
				'settings'   => 'treville_theme_options[available_fonts]',
				'choices' => array(
					'default' => __( 'Default Browser Fonts (12)', 'treville-pro' ),
					'favorites' => __( 'ThemeZee Favorite Fonts (35)', 'treville-pro' ),
					'popular' => __( 'Most Popular Google Fonts (100)', 'treville-pro' ),
					'all' => __( 'All Google Fonts (650)', 'treville-pro' ),
					),
				'priority' => 50,
			)
		) );
