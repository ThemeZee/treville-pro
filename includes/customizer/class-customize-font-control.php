...
if ( class_exists( 'WP_Customize_Control' ) ) :
	...
	class Treville_Pro_Customize_Font_Control extends WP_Customize_Control {
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->l10n = array(
				'previous' => __( 'Previous Font', 'treville-pro' ),
				'next' => __( 'Next Font', 'treville-pro' ),
				'standard' => _x( 'Default', 'default font button', 'treville-pro' ),
			);
			...
			// Set Fonts.
			$this->fonts = Treville_Pro_Custom_Font_Lists::get_fonts( $theme_options['available_fonts'] );
