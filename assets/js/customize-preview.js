...
( function( $ ) {
	...
	wp.customize( 'treville_theme_options[primary_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'treville_theme_options[secondary_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'treville_theme_options[tertiary_color]', function( value ) {
		value.bind( function( newval ) {
	...
	/* Accent Color Option */
	wp.customize( 'treville_theme_options[accent_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'treville_theme_options[highlight_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'treville_theme_options[light_gray_color]', function( value ) {
		value.bind( function( newval ) {
	...
	/* Gray Color Option */
	wp.customize( 'treville_theme_options[gray_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'treville_theme_options[dark_gray_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'treville_theme_options[link_hover_color]', function( value ) {
		value.bind( function( newval ) {
	...
	/* Button Color Option */
	wp.customize( 'treville_theme_options[button_color]', function( value ) {
		value.bind( function( newval ) {
			var text_color;
	...
	wp.customize( 'treville_theme_options[button_hover_color]', function( value ) {
		value.bind( function( newval ) {
			var text_color;
	...
	/* Title Hover Option */
	wp.customize( 'treville_theme_options[title_hover_color]', function( value ) {
		value.bind( function( newval ) {
	...
	/* Title Font Weight */
	wp.customize( 'treville_theme_options[title_is_bold]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'treville_theme_options[title_is_uppercase]', function( value ) {
		value.bind( function( newval ) {
	...
	/* Navi Font Weight */
	wp.customize( 'treville_theme_options[navi_is_bold]', function( value ) {
		value.bind( function( newval ) {
			var fontWeight = newval ? 'bold' : 'normal';
	...
	/* Navi Text Transform */
	wp.customize( 'treville_theme_options[navi_is_uppercase]', function( value ) {
		value.bind( function( newval ) {
			var textTransform = newval ? 'uppercase' : 'none';
	...
	wp.customize( 'treville_theme_options[widget_title_is_bold]', function( value ) {
		value.bind( function( newval ) {
			var fontWeight = newval ? 'bold' : 'normal';
	...
	wp.customize( 'treville_theme_options[widget_title_is_uppercase]', function( value ) {
		value.bind( function( newval ) {
			var textTransform = newval ? 'uppercase' : 'none';
